...
%
%   В даній програмі Microphone_Array_test_45_.m моделюється ситуація:
%   - напрямок на точкове джерело шуму становить 45 градусів;
...
disp(' ');
disp('Проводиться група дослідів для напрямку на заваду 45 градусів');
fs = 44100;
...
for SNR = 10:-10:-10
    ...
    disp('Прослухайте сигнал 2');
           pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/Array.wav']);
        sound(snd, fs);
    pause(10) 
  ...
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp(' ');
        disp('Прослухайте сигнал 3');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/cbfOut.wav']);
        sound(snd, fs);
    pause(10) 
  g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 4');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout1.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 5');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout2.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 6');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout3.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
...
save(d,'dB10', 'dB0', 'dBm10','dB10n', 'dB0n', 'dBm10n','dB10w', 'dB0w', 'dBm10w'); 
    ...
    figure
    plot(dB10,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка якості сигналу, кут 45');
     hold on;
    ...
    figure
    plot(dB10n,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка рівня завади, кут 45');
     hold on;
    ...
    figure
    plot(dB10w,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка загального враження, кут 45');
     hold on;
