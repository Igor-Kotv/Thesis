...
%
%   В даній програмі Microphone_Array_test_istrp_.m моделюється ситуація:
%   - шум є ізотропним;
...
disp(' ');
disp('Проводиться група дослідів для ізотропного шуму');
fs = 44100;
...
for SNR = 10:-10:-10
    ...
    disp('Прослухайте сигнал 2');
           pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/Array_istrp.wav']);
        sound(snd, fs);
    pause(10) 
  ...
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp(' ');
        disp('Прослухайте сигнал 3');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/cbfOut_istrp.wav']);
        sound(snd, fs);
    pause(10) 
  g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 4');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout1_istrp.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 5');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout2_istrp.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
  gw=input('Оцініть загальне враження від почутого:  ');
    ...
    disp('Прослухайте сигнал 6');
          pause(0.5) 
             snd=audioread([num2str(SNR) 'dB/LCMVout3_istrp.wav']);
        sound(snd, fs);
    pause(10) 
   g=input('Оцініть якість сигналу (від 1 до 5, можна дробове):  ');
  gn=input('Оцініть рівень завади:  ');
...
save(d,'dB10', 'dB0', 'dBm10','dB10n', 'dB0n', 'dBm10n','dB10w', 'dB0w', 'dBm10w'); 
    ...
    figure
    plot(dB10,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка якості сигналу, ізотропний');
     hold on;
    ...
    figure
    plot(dB10n,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка рівня завади, ізотропний');
     hold on;
    ...
    figure
    plot(dB10w,'k'); grid; ylabel('DMOS'); xlabel('Тип обробки'); title('Оцінка загального враження, ізотропний');
     hold on;
